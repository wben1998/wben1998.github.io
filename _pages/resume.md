...
* **Campus Compass — Full-Stack Application** (May 2025 – Aug 2025)
  ...
  * Developed features using React, Node.js, and Supabase
  * Followed Scrum workflows, PR reviews, and modular architecture practices
...
* **Apache Superset — Open Source Contribution** (Oct 2025 – Nov 2025)
  ...
  * Fixed UI/UX issue related to table export behavior in Superset
  * Designed UI improvements and submitted a production-ready pull request
...
Awards
======
* UTSC Teaching Assistant Award (2024)
* UTSC Contributions Awards (2023, 2024)
